...
class UtilApi
{
            ...
            switch ($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Omisai\Billingo\Models\TaxNumber',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\Omisai\Billingo\Models\TaxNumber';
        $request = $this->checkTaxNumberRequest($tax_number, $contentType);
    ...
    {
        $returnType = '\Omisai\Billingo\Models\Id';
        $request = $this->getIdRequest($id, $contentType);
    ...
    public function getServerTimeWithHttpInfo(string $contentType = self::contentTypes['getServerTime'][0])
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Omisai\Billingo\Models\ServerTime',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\Omisai\Billingo\Models\ServerTime';
        $request = $this->getServerTimeRequest($contentType);
