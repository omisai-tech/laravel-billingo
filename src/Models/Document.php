...
class Document implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'type' => '\Omisai\Billingo\Models\DocumentType',
        'cancelled' => 'bool',
        'block_id' => 'int',
        'payment_status' => '\Omisai\Billingo\Models\PaymentStatus',
        ...
        'due_date' => '\DateTime',
        'paid_date' => '\DateTime',
        'organization' => '\Omisai\Billingo\Models\DocumentOrganization',
        'partner' => '\Omisai\Billingo\Models\Partner',
        'document_partner' => '\Omisai\Billingo\Models\DocumentPartner',
        'electronic' => 'bool',
        'comment' => 'string',
        'tags' => 'string[]',
        'notification_status' => '\Omisai\Billingo\Models\DocumentNotificationStatus',
        'language' => '\Omisai\Billingo\Models\DocumentLanguage',
        'items' => '\Omisai\Billingo\Models\DocumentItem[]',
        'summary' => '\Omisai\Billingo\Models\DocumentSummary',
