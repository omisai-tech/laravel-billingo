 ...
 */
class SpendingList implements \JsonSerializable, ArrayAccess, ModelInterface
{
    ...
    protected static $openAPITypes = [
        'data' => '\Omisai\Billingo\Models\SpendingListItem[]',
        'total' => 'int',
        'per_page' => 'int',
        'current_page' => 'int',
        'last_page' => 'int',
     ...
     * Sets data
     *
     * @param  SpendingListItem[]|null  $data  data
     *
     * @return self
     */
